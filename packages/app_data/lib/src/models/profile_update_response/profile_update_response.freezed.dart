...
class _$ProfileUpdateResponseImpl extends _ProfileUpdateResponse {
  const _$ProfileUpdateResponseImpl(@JsonKey(name: "_id") this.userId,
      this.name, this.email, this.profileImage)
      : super._();
  ...
  @override
  String toString() {
    return 'ProfileUpdateResponse(userId: $userId, name: $name, email: $email, profileImage: $profileImage)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, userId, name, email, profileImage);
...
abstract class _ProfileUpdateResponse extends ProfileUpdateResponse {
  const factory _ProfileUpdateResponse(
      ...
      final String name,
      final String email,
      final String? profileImage) = _$ProfileUpdateResponseImpl;
