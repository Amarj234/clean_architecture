...
mixin _$LoginRequest {
  ...
  bool get isAuthenticate => throw _privateConstructorUsedError;
...
abstract class $LoginRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call({String email, bool isAuthenticate, String? deviceId});
}
...
class _$LoginRequestImpl extends _LoginRequest {
  const _$LoginRequestImpl(this.email, this.isAuthenticate, this.deviceId)
      : super._();
  ...
  @override
  String toString() {
    return 'LoginRequest(email: $email, isAuthenticate: $isAuthenticate, deviceId: $deviceId)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, email, isAuthenticate, deviceId);
...
abstract class _LoginRequest extends LoginRequest {
  const factory _LoginRequest(final String email, final bool isAuthenticate,
