...
abstract class $LoginResponseModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: "_id") String userId, String token});
}
...
class _$LoginResponseModelImpl extends _LoginResponseModel {
  const _$LoginResponseModelImpl(@JsonKey(name: "_id") this.userId, this.token)
      : super._();
  ...
  @override
  String toString() {
    return 'LoginResponseModel(userId: $userId, token: $token)';
  }
...
abstract class _LoginResponseModel extends LoginResponseModel {
  const factory _LoginResponseModel(
          @JsonKey(name: "_id") final String userId, final String token) =
