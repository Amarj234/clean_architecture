...
/// @nodoc
mixin _$SplashState {
  MyResult<String?> get deviceId => throw _privateConstructorUsedError;
...
abstract class $SplashStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({MyResult<String?> deviceId});
}
...
class _$SplashStateImpl implements _SplashState {
  _$SplashStateImpl({required this.deviceId});

  @override
  final MyResult<String?> deviceId;

  @override
  String toString() {
    return 'SplashState(deviceId: $deviceId)';
  }
...
abstract class _SplashState implements SplashState {
  factory _SplashState({required final MyResult<String?> deviceId}) =
      _$SplashStateImpl;

  @override
  MyResult<String?> get deviceId;
  @override
  @JsonKey(ignore: true)
  _$$SplashStateImplCopyWith<_$SplashStateImpl> get copyWith =>
      throw _privateConstructorUsedError;
